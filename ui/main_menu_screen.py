...
class MainMenuScreen:
    ...
    def _setup_ui(self):
        ...
        current_y += 80 # Gap after title

        # --- Configuration du Temps ---
        # Label for Time config is placed relative to current_y (y-center = current_y + 20 for a 40px high selector)
        ...
        # --- Expert Mode Toggle ---
        # Label for Expert Mode is placed relative to current_y (y-center = current_y + 20 for a 40px high button)
        self.labels.append(Label(center_x - 150, current_y + 20, config.TEXT_LABELS["expert_mode_label_short"], anchor="topleft"))
        ...
        btn_width = 300
        btn_height = 60
        btn_spacing = 25 # Increased spacing between main action buttons
